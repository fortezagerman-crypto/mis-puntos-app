...
# --- SECCIÓN: REGISTRO STAFF ---
    ...
    if password.strip() == "089020011":
        ...
        archivo_excel = st.file_uploader("Sube el Excel de BI", type=['xlsx'], key="bi_uploader")
        ...
        if not df.empty:
            ...
            st.download_button("📥 DESCARGAR BASE COMPLETA", buffer.getvalue(), f"puntos_{date.today()}.xlsx", "application/vnd.ms-excel")
